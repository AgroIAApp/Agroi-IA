...
export const NDMI_COLOR_RANGES = [
  ...
  {
    min: 0.1, max: 0.2, color: '#4393c3', interval: '0.1 - 0.2',
  },
  {
    min: 0.2, max: 0.3, color: '#6baed6', interval: '0.2 - 0.3',
  },
  {
    min: 0.3, max: 0.4, color: '#9ecae1', interval: '0.3 - 0.4',
  },
  {
    min: 0.4, max: 0.5, color: '#c6dbef', interval: '0.4 - 0.5',
  },
  {
    min: 0.5, max: 0.6, color: '#deebf7', interval: '0.5 - 0.6',
  },
  {
    min: 0.6, max: 0.7, color: '#ffeed1', interval: '0.6 - 0.7',
  },
  {
    min: 0.7, max: 0.8, color: '#f8e2b2', interval: '0.7 - 0.8',
  },
  {
