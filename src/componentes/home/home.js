              ...
              ? (
                <div className="container">
                  <div className="row">
                    ...
                    { images.map((image, index) => <CampoInfoCard key={index} index={index} imageId={imageNames[index]} fieldId={user2.fields[index]._id} crops={getCrops(user2.fields[index]._id)} dateUpdated={user2.fields[index].fecha} plots={user2.fields[index].plots}> </CampoInfoCard>)}
                  </div>
                </div>
              )
              : (
